...
func test_main_scene_instantiates_and_reports_texts() -> void:
	...
	assert_eq(main_scene.get_text_count(), 40, "文本管线应加载到 40 个键")
	assert_string_contains(status_label.text, "SCAFFOLD OK")
